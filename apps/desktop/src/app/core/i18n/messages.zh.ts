...
export const zh: Record<MessageKey, string> = {
  ...
  'agent.inspector.tab.context': '上下文',
  'agent.inspector.tab.outbound': '出站请求',
  ...
  'rescue.simplify.first': '先只处理第一部分。',
  'rescue.simplify.check': '确认这部分没问题，再继续。',
  'rescue.hint.action': '找找这里适用的规则或思路。',
  'rescue.hint.condition': '先确认使用它需要满足什么条件。',
  'rescue.example.pattern': '看一个例题，留意它分成了哪些步骤。',
  'rescue.example.apply': '试着把第一步用到当前任务上。',
  'rescue.break.pause': '先离开任务几分钟。',
  'rescue.break.return': '回来后，从一个小动作开始。',
